...
void Appliction_MIT_APP_Process()
{
    ...
    else if(request.indexOf("sta") > 0 )  { MIT_flag = 3; Serial.println(request); DATA = " Current Channel = "+Channel; }
    //Channel
    ...
    else if(request.indexOf("JIO_PAIR") > 0 )  { Serial.println(request); pair_remote();} 
